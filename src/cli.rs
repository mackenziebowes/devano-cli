use clap::{Parser, Subcommand};  // Bring clap derive macros into scope [oai_citation_attribution:0‡docs.rs](https://docs.rs/clap/latest/clap/#:~:text=use%20clap%3A%3AParser%3B)
